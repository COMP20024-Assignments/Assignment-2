This code contains programs necessary to run a slider game with either AI or human agents.
...
.generic        -   board reading and controlling code used in project 1

.training       -   programs used in machine learning process